...
contract TestToken is Ownable, ERC20Snapshot {

    using SafeMath for uint256;
    
    address public wAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public constant MAX_SUPPLY = 21000000000000000000000000;
    uint256 public constant INIT_SUPPLY = 10000000000000000000000000;

    constructor() ERC20("Test Token", "TEST_123") {
...
contract TestClaimWTC is Ownable{
    ...
    constructor(WaruNFT _nft, TestToken _token) {
        nft = _nft;
        token = _token;
    }
